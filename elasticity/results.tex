% \begin{figure}[tb]
% \center{\includegraphics[width=.95\linewidth]{elasticity/figures/convergence.pdf}}
% \caption{Residual reduction $|r_k|_{\infty}/|r_0|_{\infty}$ per V-cycle for a number of examples. In practice 1-3 v-cycles were necessary for each  Newton-Raphson update}
