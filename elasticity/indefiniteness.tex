...
$$
%$$
%\stackrel{\mbox{\it\small(Eqn.\ref{eqn_discrete_gradient})}}{=}V_e\!\!\sum_{j,k,l,m}\!\!T_{jklm}\delta F^e_{lm}  \delta F^e_{jk}
%=V_e\left(\delta\mathbf{F}^e:\mathcal{T}:\delta\mathbf{F}^e\right).
%$$
