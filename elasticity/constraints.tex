...
%Springs attached to embedded proxy points are used to enforce soft constraints such as bone bindings. The forces from %these springs are derived from the standard quadratic energy.
...
\textbf{Self-collision penetration depth evaluation }
