...
%%%%%% Acknowledgements %%%%%%
\acknowledgments{
(personal acknowledgements to be added).

The images in figures (\ref{fig:char}), (\ref{fig:collisions}), (\ref{fig:hand}), (\ref{fig:teaser}), (\ref{fig:thug}) were produced while working at Walt Disney Animation Studios and are copyrighted by Disney Enterprises.
